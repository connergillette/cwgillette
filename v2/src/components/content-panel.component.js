...
class ContentPanel extends Component {
    constructor(props) {
        ...
        let about_content = (<div className="content row">
            <div className="col-lg-6 col-md-12">
                <p className="small-content">
                    I am a full-stack web and software developer currently living in Seattle, Washington. I'm currently in my fourth and final year at the University of Washington Seattle, and am currently looking for full-time developer positions in the United States.</p><p>I am mostly self-taught, and have experience with <strong>JavaScript (client and server-side), Java, NodeJS, MongoDB, React, Angular, MongoDB, HTML/CSS, and Heroku.</strong>
                </p>
            </div>
            <div className="col-lg-6 col-md-12 text-center"><img src={profile_image} alt="Smiling young man wearing glasses." /></div>
        </div>);

        let resume_content = (<div className="content row">
            <div className="col-lg-6 col-md-12">
                ...
                <p>Developed <a href="https://getquickquiz.com">QuickQuiz</a>, a Slack integration that allows you to create, administer, and take quizzes. Installed by 980 teams and counting. Featured on Slack's New and Noteworthy list.</p>
                ...
                <p>Created, organized, and edited client web content using a CMS.</p>
